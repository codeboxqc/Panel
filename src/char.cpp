...
void pageFlip() {
  ...
  "Im not clumsy. The floor just hates me, the table and chairs are bullies, and the walls get in my way\0",
  "If you cant convince them, confuse them\0",
  "Im not addicted to coffee, were just in a committed relationship\0",
  "I used to play sports. Then I realized you can buy trophies. Now Im good at everything\0",
  ...
  "Do not try and bend the spoon. Thats impossible. Instead, only try to realize the truth The Matrix\0",
  ...
  "You cant stop the signal Serenity\0",
  "The truth is out there X-Files\0",
  "We are the music makers, and we are the dreamers of dreams Arthur OShaughnessy\0",
  ...
  "The first principle is that you must not fool yourselfand you are the easiest person to fool Richard Feynman\0",
  ...
  "You cant take the sky from me Firefly\0",
